console.log(`1.- A partir del siguiente arreglo de animalitos: 
    const animalitos = [
...
const fileteredAnimals = animalitos.filter(animalito => animalito.especie === 'conejo');
console.log("fileteredAnimals", fileteredAnimals);

console.log(`2.- A partir del siguiente arreglo de mascotas:
    const mascotas = [
...
const mappedMascotas = mascotas.map(mascota => mascota.nombre);
console.log('Mapped::' , mappedMascotas);